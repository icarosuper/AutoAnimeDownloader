...
- [Decisions](docs/agents/decisions.md) — read before "fixing" unusual patterns; 90 entradas autocontidas. **Comece pelo Índice do topo e leia só a entrada apontada** — o arquivo inteiro tem 2k linhas e nunca precisa ser lido de ponta a ponta
