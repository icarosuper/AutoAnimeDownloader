...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/api.TorrentFileResponse"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "api.TorrentFileResponse": {
            "type": "object",
            "properties": {
                "bytes_completed": {
                    "description": "BytesCompleted is null when per-file progress is unknown (paused torrent: rain frees the\npieces, so FileStats() fails while Files() still answers). null is \"unknown\", rendered as\n\"—\"; 0 would be the lie \"nothing downloaded\".",
                    "type": "integer",
                    "example": 780000000
                },
                "episode": {
                ...
                "path": {
                    "type": "string",
                    "example": "[Judas] Frieren - S01E03.mkv"
                },
                "size": {
                    "type": "integer",
                    "example": 1490000000
