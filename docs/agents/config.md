...
- `episode_retry_limit`, `watched_episodes_to_keep`, `max_concurrent_downloads`, `max_batch_episodes`, `max_batch_torrent_size_gb`, `max_episode_torrent_size_gb`, `min_seeders`, `max_search_pages` — >= 0
